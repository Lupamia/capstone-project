...
// ----------------------
// ✅ Cron Job (cleanup old data nightly)
// ----------------------
cron.schedule("0 0 * * *", async () => {
  try {
    const deletedCount =
      await seniorCitizenService.cleanupOldSoftDeletedCitizens();
    console.log(`[CRON] ${deletedCount} expired soft-deleted citizens removed.`);
  } catch (error) {
...
const bulkSeniorRoutes = require("../route/bulkSenior"); // ✅ Bulk upload route
...
app.use("/api/senior-citizens", bulkSeniorRoutes); // ✅ Attach bulk upload here
...
// ✅ Startup Debug Log
// ----------------------
console.log("✅ Finished setting up routes and middleware, starting server...");
